...
#define CoreLockCircleLineSelectedColor rgba(241,241,241,1)
...
#define CoreLockCircleLineSelectedCircleColor rgba(44,101,176,1)

/*
 *  连线的颜色
 */
//#define CoreLockLockLineColor rgba(34,178,246,1)
#define CoreLockLockLineColor rgba(241,241,241,1)

/*
 *  连线的宽度圆
 */
#define CoreLockLineWidth 3.0
...
/** 登录密码存储Key */
extern NSString *const LoginPWDKey;
/** 最低设置密码数目提示 */
extern NSString *const CoreLockMinItemMsg;
